...
from .parser import MultiwfnInputParser, WfnFileParser, CubeFileParser
...
class MultiwfnHarness(Harness):
    ...
    def _add_quantum_equations(
        ...
        density_eq = GoverningEquation(
            ...
            variables=[
                {"name": "ρ", "description": "Electron density", "type": "scalar_field"},
                {"name": "φᵢ", "description": "Molecular orbital i", "type": "wavefunction"},
        ...
        if wfn_data.get('method', '').upper() in ['DFT', 'B3LYP', 'PBE']:
            ks_eq = GoverningEquation(
                ...
                variables=[
                    {"name": "V_eff", "description": "Effective potential", "type": "scalar_field"},
                    {"name": "V_ext", "description": "External potential", "type": "scalar_field"},
                    {"name": "V_H", "description": "Hartree potential", "type": "scalar_field"},
                    {"name": "V_xc", "description": "Exchange-correlation potential", "type": "scalar_field"},
                ],
            )
        ...
        if analysis_type == 'elf':
            elf_eq = GoverningEquation(
                ...
                variables=[
                    {"name": "ELF", "description": "Electron localization function", "type": "scalar_field"},
                    {"name": "D_σ", "description": "Curvature of Fermi hole", "type": "scalar_field"},
                    {"name": "D_σ^0", "description": "Thomas-Fermi reference", "type": "scalar_field"},
                ],
            )
            ...
            esp_eq = GoverningEquation(
                ...
                variables=[
                    {"name": "Φ", "description": "Electrostatic potential", "type": "scalar_field"},
                    {"name": "Z_A", "description": "Nuclear charge", "type": "scalar"},
                    {"name": "R_A", "description": "Nuclear position", "type": "vector"},
                ],
            )
