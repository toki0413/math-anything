...
class NISTPotentialsClient:
    ...
    POTENTIAL_FORMS = {
        ...
        'tersoff': {
            ...
            'parameters': ['A', 'B', 'lambda', 'mu', 'beta', 'n', 'c', 'd', 'h', 'R', 'D'],
            'range': 'short_range',
        ...
        if category == 'metal':
            if 'defect' in properties or 'surface' in properties:
                recommendations.append({
                    ...
                    'mathematical_form': self.POTENTIAL_FORMS['embedded_atom']['form'],
                })
            else:
                recommendations.append({
                    'potential': 'Lennard-Jones',
                    'rationale': 'Simple and efficient for bulk properties',
                    'mathematical_form': self.POTENTIAL_FORMS['lennard_jones']['form'],
                })
    ...
    def get_cutoff_recommendations(self, potential_type: str) -> Dict[str, Any]:
        ...
        normalized = potential_type.lower().replace('-', '_').replace(' ', '_')
        return cutoffs.get(normalized, {'recommended': 'unknown', 'description': 'No recommendation available'})
