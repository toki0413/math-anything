    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "schema_summary": {
                ...
                "n_boundary_conditions": len(self.schema.mathematical_model.boundary_conditions),
            }
        }
...
class CrossEngineSession:
    ...
    def extract(self, engine_name: str, model_id: str, 
                files: Dict[str, str],
                scale: ModelScale,
                domain: str = "",
                region: Optional[Dict[str, Any]] = None,
                options: Optional[Dict[str, Any]] = None) -> ScaleModel:
    ...
    def _detect_coupling_between(self, model_a: ScaleModel, 
                                  model_b: ScaleModel) -> List[CouplingInterface]:
        """Detect coupling between two specific models."""
        interfaces = []
        
        # Determine direction (micro -> macro)
        scale_order = [ModelScale.QUANTUM, ModelScale.ATOMISTIC, 
                      ModelScale.MESOSCALE, ModelScale.CONTINUUM, ModelScale.MACRO]
        ...
        if micro_stress and macro_stress:
            interfaces.append(CouplingInterface(
        ...
        if micro_disp and macro_disp:
            interfaces.append(CouplingInterface(
                ...
                from_scale=micro_model.model_id,
                to_scale=macro_model.model_id,
                from_objects=self._get_quantity_objects(micro_model, "displacement"),
    ...
    def generate_coupled_schema(self, coupling_type: CouplingType = CouplingType.HIERARCHICAL) -> CoupledSchema:
