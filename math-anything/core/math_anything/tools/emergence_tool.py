...
async def _emergence_call(
    inp: EmergenceInput, ctx: ToolContext
) -> ToolResult[EmergenceOutput]:
    ...
    if inp.filepath:
        ...
        params = (
            result.files.get("params", {}) if hasattr(result, "files") else inp.params
        )
    else:
    ...
    output = EmergenceOutput(
        ...
        math_schema=(
            ...
            else (schema.to_dict() if hasattr(schema, "to_dict") else {})
        ),
