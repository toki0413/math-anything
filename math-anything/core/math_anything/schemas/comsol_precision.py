...
class ComsolMathematicalPrecisionExtractor(BasePrecisionExtractor):
    ...
    def _single_physics_structure(self, physics: str, params: Dict[str, Any]) -> MathematicalStructure:
        ...
        problem_type, canonical_form = physics_map.get(physics,
            ("pde_system", "L(u) = f"))
    ...
    def _coupled_physics_structure(self, modules: List[str], params: Dict[str, Any]) -> MathematicalStructure:
    ...
    def extract_variable_dependencies(self, params: Dict[str, Any]) -> List[VariableDependency]:
        ...
        if len(physics_modules) > 1 and "solid_mechanics" in physics_modules and "heat_transfer" in physics_modules:
            dependencies.append(VariableDependency(
    ...
    def extract_solution_strategy(self, params: Dict[str, Any]) -> SolutionStrategy:
        ...
        strategy_map = {
            ...
            "parametric_sweep": ("parametric_continuation", "solve for parameter range"),
        }
        ...
        return SolutionStrategy(
            ...
            iteration_type="fully_coupled" if params.get("coupling_type") == "bidirectional" else "segregated",
        )
    ...
    def extract_mathematical_decoding(self, params: Dict[str, Any]) -> MathematicalDecoding:
        ...
        return MathematicalDecoding(
            core_problem={
                "type": "multiphysics" if len(physics_modules) > 1 else "single_physics",
            ...
            solution_method={
                ...
                "solver": "MUMPS/PARDISO" if params.get("direct_solver") else "iterative",
            },
            mathematical_hierarchy=[
                {"level": "physical", "description": "conservation laws for each physics"},
