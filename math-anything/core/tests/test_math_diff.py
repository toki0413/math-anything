...
from math_anything.schemas import MathSchema, MetaInfo, MathematicalModel
from math_anything.utils import MathDiffer, DiffType
...
class TestMathDiffer(unittest.TestCase):
    ...
    def test_equation_added(self):
        ...
        self.assertEqual(changes[0].path, "mathematical_model.governing_equations.newton")
    ...
    def test_integrator_changed(self):
        ...
        from math_anything.schemas import NumericalMethod, Discretization
...
class TestDiffReport(unittest.TestCase):
    ...
    def test_critical_changes_filter(self):
        ...
        from math_anything.utils.math_diff import DiffReport, Change, DiffType
        
        report = DiffReport()
        report.numerical_changes.append(Change(
            type=DiffType.INTEGRATOR_CHANGED,
            path="test",
            severity="critical",
        ))
        report.parameter_changes.append(Change(
