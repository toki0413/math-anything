...
class GPUEvaluator:
    ...
    def _safe_eval_gpu(self, expr: str, var_dict: Dict, cp):
        ...
        NOTE: safe_eval cannot replace this eval because the expressions
        use CuPy GPU array operations which safe_eval does not support.
        The __builtins__ restriction prevents arbitrary code execution.
