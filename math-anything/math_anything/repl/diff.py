...
_pkg_root = str(Path(__file__).parent.parent.parent)  # content root
...
class MathDiff:
    ...
    def compare(cls, schema1: MathSchema, schema2: MathSchema) -> DiffResult:
        ...
        result.similarity_score = cls._calculate_similarity(schema1, schema2, eq_comparison, bc_comparison)
    ...
    def _calculate_similarity(
        ...
        if schema1.numerical_method and schema2.numerical_method:
            ...
            if (
                ...
                and nm1.discretization.space_discretization == nm2.discretization.space_discretization
            ):
                nm_score += 0.5
            if (
                nm1.discretization.time_integrator is not None
                and nm1.discretization.time_integrator == nm2.discretization.time_integrator
            ):
                nm_score += 0.5
