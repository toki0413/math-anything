...
# Add content root to path (for engine discovery)
_pkg_root = Path(__file__).parent.parent.parent  # content root
...
class REPLSession:
    ...
    def add_file(self, name: str, path: str, engine: str, schema: Optional[MathSchema] = None):
...
{self._color("cyan", "║")}  {slogan}                                                                  {self._color("cyan", "║")}
    ...
    def do_constraints(self, arg: str):
        ...
        if hasattr(schema, "symbolic_constraints") and schema.symbolic_constraints:
            ...
            for constraint in schema.symbolic_constraints:
                ...
                print(f"  {self._color(color, symbol)} {constraint.expression:40}", end="")
    ...
    def _extract_schema(self, engine: str, files: List[str]) -> Optional[MathSchema]:
        ...
        try:
            ...
            # Add more engines...
                ...
                self._print_warning(f"Schema extraction for {engine} not yet implemented")
                return None
    ...
    def _create_schema_from_apdl(self, result) -> MathSchema:
        ...
        return MathSchema(  # type: ignore[no-any-return]
            ...
            meta=MetaInfo(
                ...
                source_files={"input": [result.commands[0].raw if result.commands else ""]},
            ),
