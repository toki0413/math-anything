...
class LBMBoundaryExtractor:
    ...
    Example:
        ...
        for bc in boundaries:
            logger.info(bc.mathematical_form)
            logger.info(bc.implementation_details)
        ```
    """
    ...
    def extract_boundaries(
        ...
        for boundary_type, locations in boundary_types.items():
            for location in locations:
                bc = self._characterize_boundary(boundary_type, location, flag_field, velocity_field, density_field)
    ...
    def _create_generic_boundary(self, boundary_type: str, location: str) -> LBMBoundary:
