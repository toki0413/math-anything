...
class SemanticMapper:
    ...
    def _extract_variables(self, expression: str) -> List[str]:
        ...
        variables = [
            t
            for t in tokens
            if t not in math_functions and t not in ["d", "dt", "dx"]  # Differentiation symbols
        ]
            ...
            nodes.append(
                {
                    ...
                    "math_semantics": self.suggest_math_semantics(cmd.get("name", "")) or {},
                }
            )
