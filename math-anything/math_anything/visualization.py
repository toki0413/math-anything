...
class Visualizer:
    ...
    def _to_mermaid(self, schema: Dict[str, Any]) -> str:
        ...
        if deps and self.config.show_dependencies:
            lines.append('    Root --> Deps["Variable Dependencies"]')
        ...
        lines.append("    class ProblemType,Canonical problem")
        lines.append("    class ConstRoot,ConstStatus constraint")
        lines.append("    class ApproxRoot approximation")
