...
from ..psrn import ConservativePSRNConfig
...
class TieredSymbolicRegressionAnalyzer:
    ...
    def analyze_relationships(
        ...
        if tier >= 3:
            ...
            result["discovered_relationships"] = self._analyze_with_psrn(X, y, variable_names, tier)
        ...
        if tier >= 5:
            ...
            result["unified_representation"] = self._build_unified_representation(result, context)
    ...
    def _build_unified_representation(
        ...
        if primary:
            ...
            unified["geometric_embedding"] = {
                ...
                "symmetries": analysis_result.get("geometric_insights", {}).get("symmetry_analysis", {}),
            }
...
class IntegratedTieredAnalyzer:
    ...
    def analyze_with_symbolic_regression(
        ...
        if tier >= 3:
            sr_result = self.sr_analyzer.analyze_relationships(X, y, variable_names, tier, context)
...
def tiered_symbolic_regression_analysis(
    ...
    return analyzer.analyze_with_symbolic_regression(X, y, variable_names, file_path, tier)
