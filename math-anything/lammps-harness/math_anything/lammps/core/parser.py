...
class LammpsInputParser:
    ...
    NUMERICAL_COMMANDS = {
        "fix", "timestep", "run", "minimize", "neigh_modify",
    }
    
    # Commands that define boundary/initial conditions
    BC_COMMANDS = {
        "boundary", "region", "create_box", "fix", "velocity",
    }
    ...
    def extract_settings(self, commands: Optional[List[LammpsCommand]] = None) -> ComputationalSettings:
