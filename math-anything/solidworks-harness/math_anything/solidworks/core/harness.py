...
from .parser import CWRParser, StudyParser, MaterialParser
...
class SolidWorksHarness(Harness):
        ...
        if study_type == 'static':
            ...
            hooke = GoverningEquation(
                ...
                variables=[
                    ...
                    {"name": "λ", "description": "Lame's first parameter", "type": "scalar"},
            ...
            fourier = GoverningEquation(
                ...
                variables=[
                    ...
                    {"name": "k", "description": "Thermal conductivity", "type": "scalar"},
            ...
            buckling = GoverningEquation(
                ...
                variables=[
                    ...
                    {"name": "K_σ", "description": "Geometric stiffness", "type": "matrix"},
    ...
    def _add_boundary_conditions(self, schema: MathSchema, results_data: Dict[str, Any]):
        """Add boundary conditions."""
        ...
        for i, constraint in enumerate(fixed):
            bc = BoundaryCondition(
                ...
                variables=[{"name": "u", "description": "Displacement", "type": "vector"}],
    ...
    def _add_mathematical_objects(self, schema: MathSchema, results_data: Dict[str, Any]):
        """Add mathematical objects."""
    ...
    def _add_numerical_method(self, schema: MathSchema, results_data: Dict[str, Any]):
        ...
        element_info = self.ELEMENT_TYPES.get(element_quality, {'order': 'quadratic', 'nodes': 10})
