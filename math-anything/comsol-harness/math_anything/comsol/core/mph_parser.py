...
class ComsolSymbolicConstraints:
    ...
    @classmethod
    def validate_parameter(cls, param_name: str, value: float, unit: str = "") -> List[Dict[str, Any]]:
        ...
        try:
            ...
            for param in root.iter('parameter'):
                ...
                if isinstance(value, float):
                    ...
                    validations = ComsolSymbolicConstraints.validate_parameter(name, value, unit)
