...
class VaspExtractor:
    ...
    def _analyze_symmetry(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if hasattr(self.structure, "lattice") and hasattr(
                self.structure.lattice, "vectors"
            ):
            ...
            if hasattr(self.structure, "atoms"):
                positions = [
                    (
                        a.position.tolist()
                        if hasattr(a.position, "tolist")
                        else list(a.position)
                    )
                ...
                positions = (
                    self.structure.positions.tolist()
                    if hasattr(self.structure.positions, "tolist")
                    else list(self.structure.positions)
                )
