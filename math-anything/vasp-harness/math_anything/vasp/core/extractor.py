...
from .parser import (
    VaspInputParser, VaspOutputParser,
    ElectronicParameters, CrystalStructure,
)
...
class VaspExtractor:
    ...
    def _extract_kohn_sham_equations(self) -> List[GoverningEquation]:
        ...
        equations.append(GoverningEquation(
            ...
            parameters={
                ...
                "spin_polarized": self.elec_params.ispin == 2 if self.elec_params else False,
            },
        ...
        equations.append(GoverningEquation(
            ...
            variables=["energy", "density", "kinetic_energy", "external_potential", "hartree_energy", "exchange_correlation"],
            ...
            if self.input_parser.kpoints:
                ...
                bcs.append(BoundaryCondition(
                    ...
                    mathematical_object=MathematicalObject(
                        ...
                        components=[
                            TensorComponent(index=[i+1], value=str(k), unit="1/Angstrom")
    ...
    def _extract_computational_graph(self, results: Optional[Any]) -> ComputationalGraph:
        ...
        graph.add_node(ComputationalNode(
            ...
            math_semantics={
                ...
                "convergence": {
                    "required": True,
                    "criterion": f"energy_change < {self.elec_params.ediff}" if self.elec_params else "energy_change < threshold",
                    "max_iterations": self.elec_params.nelm if self.elec_params else 60,
                },
            },
        ))
    ...
    def _extract_raw_symbols(self) -> Dict[str, Any]:
        ...
        symbols = {
            ...
            "kpoints": self.input_parser.kpoints.to_dict() if self.input_parser.kpoints else {},
        }
