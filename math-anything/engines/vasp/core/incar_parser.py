...
class IncarParser:
    ...
    PARAMETER_DEFS = {
        ...
        # Ionic relaxation
        "NSW": {"type": int, "constraints": [">= 0"], "description": "Max ionic steps"},
        "EDIFFG": {
            "type": float,
            "constraints": ["!= 0"],
        ...
        "MAGMOM": {"type": str, "constraints": [], "description": "Magnetic moments"},
        # Parallelization
        "NCORE": {
            "type": int,
            "constraints": ["> 0"],
        ...
        "LWAVE": {"type": bool, "constraints": [], "description": "Write WAVECAR"},
        "LCHARG": {"type": bool, "constraints": [], "description": "Write CHGCAR"},
    }
