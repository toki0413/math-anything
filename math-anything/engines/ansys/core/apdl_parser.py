    ...
    MESH_CONSTRAINTS = {
        "ESIZE": [
            ...
            (
                ...
                "Element size should be small enough (warning)",
            ),
        ],
        "SMRTSIZE": [
...
class EnhancedAPDLParser:
    ...
    def _parse_material_property(self, args: List[str]):
        ...
        mat_prop = MaterialProperty(
            ...
            constraints=[
                c[0]
                for c in APDLSymbolicConstraints.MATERIAL_CONSTRAINTS.get(prop_name, [])
            ],
        )
        self.materials.append(mat_prop)

        # Validate constraints
        validations = APDLSymbolicConstraints.validate_material_property(
            prop_name, value
        )
            ...
            if "EX" in prop_names and "PRXY" in prop_names:
                ...
                if ex and prxy is not None:
                    ...
                    if lam is not None:
                        ...
                        model_dict["incompressible_warning"] = (
                            "Poisson's ratio = 0.5 (incompressible limit)"
                        )
