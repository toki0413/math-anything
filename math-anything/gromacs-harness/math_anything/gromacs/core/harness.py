...
from math_anything.schemas.math_schema import (
    ...
    ComputationalGraph, MathematicalObject,
...
from .parser import MDPParser, TOPParser, TPRParser, EDTParser
    ...
    def _add_governing_equations(
        ...
        bond = GoverningEquation(
            ...
            variables=[
                ...
                {"name": "r₀", "description": "Equilibrium bond length", "type": "scalar"},
            ],
        )
        ...
        angle = GoverningEquation(
            ...
            variables=[
                {"name": "k_θ", "description": "Angle force constant", "type": "scalar"},
        ...
        if integrator in ['md', 'sd']:
            ...
            if tcoupl != 'no':
                thermostat_eq = GoverningEquation(
                    ...
                    variables=[
                        {"name": "T", "description": "Instantaneous temperature", "type": "scalar"},
                        {"name": "T₀", "description": "Target temperature", "type": "scalar"},
                        {"name": "τ_T", "description": "Coupling time constant", "type": "scalar"},
                    ],
                )
        ...
        if pcoupl != 'no':
            barostat_eq = GoverningEquation(
                ...
                variables=[
                    {"name": "P", "description": "Instantaneous pressure", "type": "scalar"},
                    {"name": "P₀", "description": "Target pressure", "type": "scalar"},
                    {"name": "τ_P", "description": "Coupling time constant", "type": "scalar"},
                ],
            )
    ...
    def _add_boundary_conditions(self, schema: MathSchema, mdp_data: Dict[str, Any]):
        ...
        if constraints != 'none':
            constraint_bc = BoundaryCondition(
                ...
                variables=[
                    {"name": "d₀", "description": "Constraint distance", "type": "scalar"},
                ],
